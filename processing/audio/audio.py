...
pygame.mixer.init()
ambi1 = pygame.mixer.Sound('forest.wav')
ambi2 = pygame.mixer.Sound('montagne.wav')
ambi3 = pygame.mixer.Sound('desert.wav')
ambi4 = pygame.mixer.Sound('lava.wav')
sound1 = pygame.mixer.Sound('firework.wav')
sound2 = pygame.mixer.Sound('thunder.wav')
